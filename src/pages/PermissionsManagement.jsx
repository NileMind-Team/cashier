...
export default function PermissionsManagement() {
  ...
  const handlePermissionChange = (permissionId) => {
    ...
    setTimeout(() => setIsTogglingPermission(false), 300);
  };
  ...
  const handleCopyPermissions = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        await fetchEmployeePermissions(copyId);
        ...
        <div className="bg-white rounded-2xl shadow-lg p-5 mb-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex gap-2">
              <select
                className="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm min-w-[200px] disabled:opacity-50 disabled:cursor-not-allowed"
                ...
                disabled={isSelectingEmployee || loading}
              >
              ...
              {selectedEmployee && (
                <button
                  ...
                  className="px-4 py-2 border border-amber-500 text-amber-500 rounded-lg hover:bg-amber-50 transition-colors text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1"
                >
              ...
              {selectedEmployee &&
                employees.filter(
                  ...
                  <button
                    ...
                    disabled={isCopyingPermissions}
                    className="px-4 py-2 border border-purple-500 text-purple-500 rounded-lg hover:bg-purple-50 transition-colors text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1"
                  >
          ...
          <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        disabled={isSelectingAll || isClearingAll}
            ...
            <div className="flex justify-end mt-8">
              <button
                ...
                disabled={isSavingPermissions || loading}
                className={`px-8 py-4 rounded-xl font-bold text-white transition-all transform hover:scale-[1.02] active:scale-[0.98] flex items-center shadow-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100`}
